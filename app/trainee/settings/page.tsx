      ...
      <div className="flex">
        ...
        <div className="fixed h-full w-16 bg-white shadow-md md:w-64">
          ...
          <nav className="mt-6">
            ...
            <Link href="/settings" className="flex items-center px-4 py-3 text-purple-600 bg-purple-100">
          ...
          <div className="p-4 md:p-8">
            <div className="rounded-lg bg-white p-6 shadow-md">
              ...
              <div className="rounded-lg bg-purple-50 p-8 text-center">
                ...
                <h2 className="mb-2 text-xl font-semibold text-gray-800">Account Settings</h2>
                <p className="text-gray-600">Account settings and preferences will be available here soon.</p>
              </div>
            </div>
          </div>
        </div>
