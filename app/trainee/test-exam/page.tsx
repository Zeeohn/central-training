      ...
      <div className="flex">
        ...
        <div className="fixed h-full w-16 bg-white shadow-md md:w-64">
          ...
          <nav className="mt-6">
            ...
            <Link href="/test-exam" className="flex items-center px-4 py-3 text-purple-600 bg-purple-100">
        ...
        <div className="ml-16 flex-1 md:ml-64">
          <div className="p-4 md:p-8">
            <div className="rounded-lg bg-white p-6 shadow-md">
              <h1 className="mb-4 text-2xl font-bold text-gray-800">Tests & Exams</h1>
              ...
              <div className="rounded-lg bg-purple-50 p-8 text-center">
                ...
                <h2 className="mb-2 text-xl font-semibold text-gray-800">
                  Your Test/Exam Questions Will Be Uploaded Here
                </h2>
                <p className="text-gray-600">
                  Check back soon for upcoming tests and exams. When available, they will appear in this section.
                </p>
              </div>
            </div>
          </div>
